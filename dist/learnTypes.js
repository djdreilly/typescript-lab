...
const myNum = 123.3; // floating point
const myNum2 = 123; // integer
// String
const myStr = "some text";
const myStr2 = `my_num is ${myNum} and my_num2 is ${myNum2}`;
...
whatever = "123";
whatever = null;
const arrOfWhatever = ["a", 123, false, null];
/*
...
const idToName = new Map([[1234354554, 'ava'],
    [1234444556, 'lark'],
    [1233334445, 'erwin']]);
const new_id = 123333555;
...
const value = idToName.get(new_id);
...
const freezing = -32;
const optNum = null;
const optNumPair = [null, 123];
const optStrings = [null, null, "a", "b", null];
const myCoords = [0, 0];
const addressBook = new Map();
const letters = ['X', 'Y', 'Y', 'X'];
const my3x3Matrix = [
    [1, 0, 0],
    [0, 1, 0],
    [0, 0, 1]
...
//    [ 0, 0, 1 ]
// ]
//# sourceMappingURL=learnTypes.js.map